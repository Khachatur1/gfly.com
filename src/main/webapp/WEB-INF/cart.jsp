    ...
    <section class="cart">
        <div class="container">
            <div class="cart-holder">
                ...
                <div class="cart-body text-center">
                    <div class="row cart-item">
                        <div class="col-5">
                            <div class="product-overview text-left d-flex"><a href="/detail"
                                                                              class="product-img"><img
                                    src="../static/img/cart-item.jpg"
                                    alt="product" class="img-fluid"></a>
                                <div class="product-details"><a href="/detail">
            ...
            <div class="total-price text-right">
                <div class="container">
                    <div class="d-flex justify-content-end align-items-center"><span
                            class="h3">Total: &nbsp;</span><strong class="h2 text-primary">$500</strong></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="form-holder">
                <form id="shipping-address-form" action="#" method="post" class="custom-form">
                    ...
                    <div class="shipping-main">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 form-group">
                                <input type="text" name="address-2" placeholder="Apt, Suit, etc." required=""
                                       class="form-control">
                            </div>
                            <div class="col-sm-6 form-group">
                    ...
                    <div class="shipping-alternative">
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                <input type="text" name="sfirstname" placeholder="First Name" required=""
                                       class="form-control">
                            </div>
                            <div class="col-sm-6 form-group">
                                <input type="text" name="slastname" placeholder="Last Name" required=""
                                       class="form-control">
                            </div>
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6 form-group">
                                <input type="text" name="snumber" placeholder="Phone Number" required=""
                                       class="form-control">
                            </div>
                            <div class="col-sm-8 form-group">
                                <input type="text" name="saddress-1" placeholder="Address" required=""
                                       class="form-control">
                            </div>
                            <div class="col-sm-4 form-group">
                                <input type="text" name="saddress-2" placeholder="Apt, Suit, etc." required=""
                                       class="form-control">
                            </div>
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6 form-group">
                                <input type="text" name="spostalcode" placeholder="Postal Code" required=""
                                       class="form-control">
                            </div>
                            <div class="col-sm-6 form-group">
                    ...
                    <div class="payment-method">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                <input type="text" name="cardnumber" placeholder="Card Number" maxlength="14"
                            ...
                            <div class="col-sm-12 text-center">
                                <button id="shipping-submit" type="submit" class="oder-now btn btn-unique btn-lg">Order
                                    Now <i class="icon-shipping-truck"></i></button>
                            </div>
                        </div>
                    </div>
                </form>
