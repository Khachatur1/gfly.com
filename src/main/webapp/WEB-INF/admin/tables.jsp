                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${products}" var="product">
                                    <tr>
                                        ...
                                        <td><img src="/product/image?fileName=${product.picUrl}" width="10%"></td>
                        ...
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><img src="/category/image?fileName=${category.picUrl}" width="10%"></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                        ...
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><img src="/post/image?fileName=${post.picUrl}" width="10%"></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
...
<link href="../../static/admin/vendors/datatables/dataTables.bootstrap.css" rel="stylesheet" media="screen">
...
<script src="../../static/admin/vendors/datatables/dataTables.bootstrap.js"></script>

<script src="../../static/admin/js/custom.js"></script>
<script src="../../static/admin/js/tables.js"></script>
</body>
</html>